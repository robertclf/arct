class ArctanEpicyclesController extends CanvasController {
    ...
    constructor(id, width, height) {
        ...
        this.pathColor = palette.blue;
        this.circlesColor = palette.cyan;
    }
    ...
    renderCircles() {
        ...
        for (let i = 0; i < numFouriers; i ++) {
            ...
            this.context.strokeStyle = this.circlesColor;
